 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |   Z  |   X  |   C  |Space | LowerRaise  |QWERTY| Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_GAMING] = {
  {KC_ESC,  KC_1, KC_2, KC_3, KC_4,   KC_5,        KC_6,        KC_7,        KC_8,    KC_9,    KC_0,   KC_BSPC  },
  {KC_TAB,  KC_Q, KC_W, KC_E, KC_R,   KC_T,        KC_Y,        KC_U,        KC_I,    KC_O,    KC_P,   KC_BSPC  },
  {KC_LSFT, KC_A, KC_S, KC_D, KC_F,   KC_G,        KC_H,        KC_J,        KC_K,    KC_L,    KC_DOT, ENT_RSFT },
  {KC_LCTL, KC_Z, KC_X, KC_C, KC_SPC, EXIT_GAMING, EXIT_GAMING, QWERTY_TEMP, KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT  }
},
...
[_QWERTY_TEMP] = {
  ...
  {KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT },
  {KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, ENT_RSFT},
  {BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT }
},
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case QWERTY_TEMP:
      if (record->event.pressed) {
        layer_on(_QWERTY_TEMP);
      } else {
        layer_off(_QWERTY_TEMP);
      }
      return false;
      break;
    case COLEMAK:
